"""Scaffold import checks for the comparison stage.
...
def test_comparison_modules_import() -> None:
    from app.comparison import models, router, schemas, service  # noqa: F401
