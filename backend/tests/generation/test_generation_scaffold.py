"""Scaffold import checks for the generation stage.
...
def test_generation_modules_import() -> None:
    from app.generation import models, router, schemas, service  # noqa: F401
